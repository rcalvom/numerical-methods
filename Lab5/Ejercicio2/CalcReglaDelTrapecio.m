...
% evaluar la integral
M = input("Ingrese la cantidad de nodos para evaluar la integral: ") - 1;
...
disp(newline + "La aproximación de la integral desde " + num2str(a) + " hasta " + num2str(b) + " de la funcion " + regF + " es: "); T